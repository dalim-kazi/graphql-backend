...
const userResolver = {
    Query: {
        users: () => __awaiter(void 0, void 0, void 0, function* () { return yield prisma_1.default.user.findMany(); }),
        user: (_1, _a) => __awaiter(void 0, [_1, _a], void 0, function* (_, { id }) { return yield prisma_1.default.user.findUnique({ where: { id } }); }),
    },
    Mutation: {
